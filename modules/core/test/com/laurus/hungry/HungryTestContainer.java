...
public class HungryTestContainer extends TestContainer {

    public HungryTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/laurus/hungry/app.properties",
    ...
    public static class Common extends HungryTestContainer {

        public static final HungryTestContainer.Common INSTANCE = new HungryTestContainer.Common();
